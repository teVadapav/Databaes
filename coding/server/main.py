...
def trigger_outbound_sms(payload: SmsCommunicationRequest):
    ...
    templates = {
        "welcome": {
            "en": f"[KHETSEVA] Welcome {name}! Your farm profile in {district_name} is active. Advisories will arrive in English. Helpline: 1800-180-1551.",
            "hi": f"[खेतसेवा] स्वागत है {name} जी! {district_name} में आपका खेत पंजीकृत हो गया है। सभी सलाह हिंदी में मिलेंगी। हेल्पलाइन: 1800-180-1551.",
            "mr": f"[खेतसेवा] स्वागत आहे {name} जी! {district_name} मध्ये आपली शेती नोंदणीकृत झाली आहे. सर्व सल्ला मराठीत मिळेल. हेल्पलाइन: 1800-180-1551.",
            "as": f"[খেতসেৱা] স্বাগতম {name}! {district_name} জিলাত আপোনাৰ কৃষি পঞ্জীয়ন সম্পূৰ্ণ হ'ল। সকলো বাৰ্তা অসমীয়াত পাব। হেল্পলাইন: 1800-180-1551.",
            "or": f"[ଖେତସେବା] ସ୍ୱାଗତ {name}! {district_name} ରେ ଆପଣଙ୍କ କୃଷି ପ୍ରୋଫାଇଲ୍ ସକ୍ରିୟ ହୋଇଛି। ସମସ୍ତ ସୂଚନା ଓଡ଼ିଆରେ ମିଳିବ। ହେଲ୍ପଲାଇନ୍: 1800-180-1551.",
            "kn": f"[ಖೇತ್‌ಸೇವಾ] ಸ್ವಾಗತ {name}! {district_name} ನಲ್ಲಿ ನಿಮ್ಮ ಕೃಷಿ ಪ್ರೊಫೈಲ್ ಸಕ್ರಿಯವಾಗಿದೆ. ಮಾಹಿತಿ ಕನ್ನಡದಲ್ಲಿ ಲಭ್ಯ. ಸಹಾಯವಾಣಿ: 1800-180-1551."
        },
        "advisory_alert": {
            "en": f"[KHETSEVA ALERT] {name}: Critical weather & market update for {crop} in {district_name}. Open app or press 1 on IVR. Helpline: 1800-180-1551.",
            "hi": f"[खेतसेवा चेतावनी] {name}: {district_name} में {crop} हेतु मौसम व भाव अलर्ट। ऐप खोलें या IVR पर 1 दबाएं। हेल्पलाइन: 1800-180-1551.",
            "mr": f"[खेतसेवा अलर्ट] {name}: {district_name} मध्ये {crop} पिकासाठी हवामान व बाजारभाव सूचना. ॲप उघडा किंवा IVR वर १ दाबा. हेल्पलाइन: 1800-180-1551.",
            "as": f"[খেতসেৱা সতৰ্কবাৰ্তা] {name}: {district_name}ত {crop} শস্যৰ বতৰ আৰু দৰ সতৰ্কবাৰ্তা। এপ খোলক বা IVRত ১ টিপক। হেল্পলাইন: 1800-180-1551.",
            "or": f"[ଖେତସେବା ସତର୍କତା] {name}: {district_name} ରେ {crop} ପାଇଁ ପାଣିପାଗ ଓ ଦର ସୂଚନା। ଆପ୍ ଖୋଲନ୍ତୁ କିମ୍ବା IVR ରେ ୧ ଦବାନ୍ତୁ। ହେଲ୍ପଲାଇନ୍: 1800-180-1551.",
            "kn": f"[ಖೇತ್‌ಸೇವಾ ಎಚ್ಚರಿಕೆ] {name}: {district_name} ದಲ್ಲಿ {crop} ಬೆಳೆಗೆ ಹವಾಮಾನ ಮತ್ತು ದರ ಎಚ್ಚರಿಕೆ. ಆ್ಯಪ್ ನೋಡಿ ಅಥವಾ IVR ೧ ಒತ್ತಿ. ಸಹಾಯವಾಣಿ: 1800-180-1551."
        }
    }
...
def trigger_outbound_ivr_call(payload: IvrCommunicationRequest):
    ...
    voice_prompts = {
        "welcome": {
            "en": f"Welcome {name} to KhetSeva Advisory Helpline. For Weather press 1, for Mandi prices press 2, for Government relief schemes press 3.",
            "hi": f"नमस्ते {name} किसान भाई! खेतसेवा में आपका स्वागत है। मौसम सलाह हेतु 1 दबाएं, मंडी भाव हेतु 2 दबाएं, सरकारी योजनाओं हेतु 3 दबाएं।",
            "mr": f"नमस्कार {name} शेतकरी बंधू! खेतसेवा हेल्पलाइनमध्ये आपले स्वागत आहे. हवामानासाठी १ दाबा, बाजारभावासाठी २ दाबा, शासकीय योजनांसाठी ३ दाबा.",
            "as": f"নমস্কাৰ {name} কৃষক ভাই! খেতসেৱালৈ আপোনাক স্বাগতম। বতৰৰ বাবে ১ টিপক, বজাৰ দৰৰ বাবে ২ টিপক, চৰকাৰী আঁচনিৰ বাবে ৩ টিপক।",
            "or": f"ନମସ୍କାର {name} କୃଷକ ଭାଇ! ଖେତସେବାକୁ ଆପଣଙ୍କୁ ସ୍ୱାଗତ। ପାଣିପାଗ ପାଇଁ ୧ ଦବାନ୍ତୁ, ମଣ୍ଡି ଦର ପାଇଁ ୨ ଦବାନ୍ତୁ, ସରକାରୀ ଯୋଜନା ପାଇଁ ୩ ଦବାନ୍ତୁ।",
            "kn": f"ನಮಸ್ಕಾರ {name} ರೈತ ಬಾಂಧವರೇ! ಖೇತ್‌ಸೇವಾಗೆ ತಮಗೆ ಸ್ವಾಗತ. ಹವಾಮಾನಕ್ಕಾಗಿ ೧ ಒತ್ತಿ, ಮಂಡಿ ಬೆಲೆಗಾಗಿ ೨ ಒತ್ತಿ, ಸರ್ಕಾರಿ ಯೋಜನೆಗಳಿಗಾಗಿ ೩ ಒತ್ತಿ."
        }
    }
...
def simulate_ivr(payload: IvrRequest):
    ...
    def get_main_menu_content(l):
        ...
        greetings = {
            "mr": f"नमस्कार {farmer_name} शेतकरी बंधू! आपल्या {loc_crop} पिकासाठी खेतसेवा सल्ला व साहाय्य केंद्रात आपले स्वागत आहे.",
            "or": f"ନମସ୍କାର {farmer_name} କୃଷକ ଭାଇ! ଆପଣଙ୍କ {loc_crop} ଫସଲ ପାଇଁ ଖେତସେବା ପରାମର୍ଶ କେନ୍ଦ୍ରକୁ ସ୍ୱାଗତ।",
            "as": f"নমস্কাৰ {farmer_name} কৃষক ভাই! আপোনাৰ {loc_crop} শস্যৰ বাবে খেতসেৱালৈ স্বাগতম।",
            "kn": f"ನಮಸ್ಕಾರ {farmer_name} ರೈತ ಬಾಂಧವರೇ! ನಿಮ್ಮ {loc_crop} ಬೆಳೆಗಾಗಿ ಖೇತ್‌ಸೇವಾ ಸಲಹಾ ಕೇಂದ್ರಕ್ಕೆ ತಮಗೆ ಸುಸ್ವಾಗತ.",
            "hi": f"नमस्ते {farmer_name} किसान भाई! आपकी {loc_crop} फसल हेतु खेतसेवा सलाह एवं सहायता केंद्र में आपका स्वागत है।",
            "en": f"Welcome {farmer_name} to KhetSeva Advisory Helpline for your {loc_crop} crop."
        }
        menus = {
